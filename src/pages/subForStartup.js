...
const SubBranch = () => {
    const subBranches = [
        { name: "Buy Stall", description: "Get your own stall with top-notch quality and convenience." },
        { name: "Advance Rent for Shop", description: "Secure your shop space with advance rent options." },
        { name: "Shop Assets", description: "Browse through various shop assets available for purchase." },
        { name: "Shop Machinery", description: "Find reliable and efficient machinery for your shop." },
    ];
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div className={`bg-white p-8 rounded-xl ${popupWidth}`}>
                        ...
                        <div className="mb-4">
                            ...
                            />
                            <span className="text-blue-500">Minimum initial deposit: PKR 1 Lakh</span>
                        </div>
